...
class CRM_Civiconfig_Form_EditEntity extends CRM_Civiconfig_Form_Edit {
  ...
  public function buildQuickForm() {
    ...
    if ($this->isTabContent()) {
      $this->assign('configuration_template', $this->entityExporterClass->getExportConfigurationForm()
        ->getConfigurationTemplateFileName());
      $configuration = [];
      if (isset($this->configItemSet['configuration']) && isset($this->configItemSet['configuration'][$this->entityName])) {
        $configuration = $this->configItemSet['configuration'][$this->entityName];
      }
      $this->entityExporterClass->getExportConfigurationForm()
  ...
  public function postProcess() {
    ...
    $this->configItemSet['configuration'][$this->entityName] = $this->entityExporterClass->getExportConfigurationForm()->processConfiguration($submittedValues, $this->configItemSet);
