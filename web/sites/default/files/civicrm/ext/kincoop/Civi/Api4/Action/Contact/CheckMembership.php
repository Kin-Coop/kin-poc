 ...
 * If Membership_Valid_Until (custom_80) is today or earlier,
...
class CheckMembership extends AbstractAction {
  ...
  public function _run(Result $result) {
    ...
    $expiredContacts = Contact::get(FALSE)
      ->addSelect('id')
      ->addJoin('EntityTag AS et', 'INNER', 'id', 'et.entity_id')
      ->addWhere('et.tag_id', '=', 10)
      ->addWhere('et.entity_table', '=', 'civicrm_contact')
      ->addWhere('is_deleted', '=', 0)
      ->addWhere('custom_80', '<=', $today)
      ->execute();
