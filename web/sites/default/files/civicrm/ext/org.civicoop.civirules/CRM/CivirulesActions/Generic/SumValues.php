...
class CRM_CivirulesActions_Generic_SumValues extends CRM_Civirules_Action {
  ...
  public function userFriendlyConditionParams() {
    ...
    return E::ts('Sum fields: %1 and store it into %2', [1=>implode(', ', $source_fields), 2=>$target_field]);
  }
