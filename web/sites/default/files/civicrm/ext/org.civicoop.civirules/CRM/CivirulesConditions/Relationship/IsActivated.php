 ...
 */
class CRM_CivirulesConditions_Relationship_IsActivated extends CRM_Civirules_Condition {
  ...
  public function isConditionValid(CRM_Civirules_TriggerData_TriggerData $triggerData) {
    ...
    // if end_date is empty or later than today, activated
    if (!isset($relationship['end_date']) || empty($relationship['end_date']) || $relationship['end_date'] == "NULL") {
      return TRUE;
    }
    else {
