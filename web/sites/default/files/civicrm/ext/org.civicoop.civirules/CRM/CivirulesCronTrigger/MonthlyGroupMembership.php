...
class CRM_CivirulesCronTrigger_MonthlyGroupMembership extends CRM_Civirules_Trigger_Cron {
  ...
  protected function getNextEntityTriggerData() {
    if (((int)$this->triggerParams['day']) != ((int) date('j'))) {
      return FALSE;
    }
  ...
  public function getExtraDataInputUrl($ruleId) {
    return CRM_Utils_System::url('civicrm/civirule/form/trigger/monthlygroupmembership/', 'rule_id=' . $ruleId);
  }
  ...
  public function getTriggerDescription(): string {
    ...
    return trim(E::ts('Monthly trigger for all members of group %1 on day %2 of the month. %3', [
      1 => $groupName,
      2 => $day,
      3 => $time,
    ]));
