...
class CRM_CivirulesCronTrigger_Form_MonthlyGroupMembership extends CRM_CivirulesTrigger_Form_Form {
  ...
  public function buildQuickForm() {
    ...
    $this->add('text', 'day', E::ts('Day of the month'), ['size' => CRM_Utils_Type::TWO], TRUE);
  ...
  public function postProcess() {
    ...
    $this->triggerParams['day'] = $this->getSubmittedValue('day');
