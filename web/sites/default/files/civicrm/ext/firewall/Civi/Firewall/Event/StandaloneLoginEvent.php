...
/**
 * Class StandaloneLoginEvent
 */
class StandaloneLoginEvent extends \Civi\Core\Event\GenericHookEvent {

  public const EVENT_TYPE = 'StandaloneLoginEvent';
  ...
  public static function trigger(string $ipAddress, ?string $source = NULL) {
    $event = new \Civi\Firewall\Event\StandaloneLoginEvent($ipAddress, $source);
    \Civi::dispatcher()->dispatch('civi.firewall.standalonelogin', $event);
  }
