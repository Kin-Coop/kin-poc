...
use Civi\Mjwshared\PaymentProcessorWebhookInterface;

/**
 * Process queued PaymentprocessorWebhook events. Called by the
 * "Process PaymentProcessor Webhooks" scheduled job.
 */
class ProcessPaymentprocessorWebhooks extends AbstractAction {
  ...
  public function _run(Result $result) {
    ...
    foreach ($paymentProcessorWebhooksResult as $webhookEvent) {
      ...
      if ($implementsInterface || method_exists($paymentProcessor, 'processWebhookEvent')) {
        ...
        // Civi\Mjwshared\PaymentProcessorWebhookInterface) have responsibility to:
        //
