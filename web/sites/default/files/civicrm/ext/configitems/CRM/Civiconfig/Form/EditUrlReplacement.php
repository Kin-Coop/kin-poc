...
class CRM_Civiconfig_Form_EditUrlReplacement extends CRM_Core_Form {
  ...
  public function buildQuickForm() {
    ...
    CRM_Utils_System::setTitle(E::ts('Add URL replacement for %1', [1=>$this->configItemSet['title']]));
    ...
    foreach($urls as $urlKey => $url) {
      if ($url instanceof \Civi\ConfigItems\UrlReplacer\ConfigurableUrl) {
    ...
    $this->add('select', 'url', E::ts('Url/Link'), $urlOptions, true, array(
