...
class CampaignTypeDefinition extends SimpleEntityDefinition {
   ...
   * @var bool
   */
  static protected $isCampaignComponentEnabled;
  ...
  public static function isAvailable() {
    return in_array('CiviCampaign', \Civi::settings()->get('enable_components'));
  }
