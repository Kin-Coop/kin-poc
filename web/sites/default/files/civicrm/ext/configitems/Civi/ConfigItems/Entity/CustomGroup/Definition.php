...
class Definition extends EntityDefinition {
  ...
  /**
   * @return \Civi\ConfigItems\Entity\CustomGroup\Importer
   */
  protected $importer;

  /**
   * @return \Civi\ConfigItems\Entity\CustomGroup\Exporter
   */
  protected $exporter;

  public function __construct($afterEntities=[], $beforeEntities=[]) {
    parent::__construct('CustomGroup', $afterEntities, $beforeEntities);
    $this->title_plural = E::ts('Custom Groups');
    $this->title_single = E::ts('Custom Group');
  }
